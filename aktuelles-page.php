...
?>
	...
	<div id="primary" class="content-area">
		<div id="content" class="site-content" role="main">
			<article class="hentry"><header class="entry-header"><h1 class="entry-title headline-aktuelles">AKTUELLES</h1></header></article>
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<?php get_post_meta($post_id, 'title_text', $single); ?>
						<h2 class="entry-title"><?php echo get_post_meta($post->ID, 'title_text', true); ?></h2>
